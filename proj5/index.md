...
Here are the outputs of the 3 prompts when `num_inference_steps=20`. The quality of the images here are much better than when fewer inference steps are used.
